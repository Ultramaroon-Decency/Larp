...
from app.api.v1.endpoints import agents, auth, health, reports, research, users, wallet, websockets
...
api_router.include_router(wallet.router, prefix="/wallet", tags=["Autonomous Wallet"])
